...
const CATEGORY_STYLES: Record<string, { bg: string; border: string; icon: any; text: string; glow: string }> = {
    ...
    'E-commerce': { bg: 'bg-blue-50 dark:bg-blue-500/10', border: 'border-blue-200 dark:border-blue-500/20', icon: ShoppingBag, text: 'text-blue-600 dark:text-blue-400', glow: 'shadow-primary-200/50 dark:shadow-primary-900/50' },
    'Accounting': { bg: 'bg-indigo-50 dark:bg-indigo-500/10', border: 'border-indigo-200 dark:border-indigo-500/20', icon: FileText, text: 'text-indigo-600 dark:text-indigo-400', glow: 'shadow-primary-200/50 dark:shadow-primary-900/50' },
    ...
    'Analytics': { bg: 'bg-blue-50 dark:bg-blue-500/10', border: 'border-blue-200 dark:border-blue-500/20', icon: BarChart3, text: 'text-blue-600 dark:text-blue-400', glow: 'shadow-primary-200/50 dark:shadow-primary-900/50' },
    ...
    'Advanced': { bg: 'bg-indigo-50 dark:bg-indigo-500/10', border: 'border-indigo-200 dark:border-indigo-500/20', icon: Zap, text: 'text-indigo-600 dark:text-indigo-400', glow: 'shadow-primary-200/50 dark:shadow-primary-900/50' },
...
const WorkflowNodeComponent: React.FC<NodeProps> = ({ data, selected }) => {
    ...
    if (isTrigger) {
      ...
      `}>
                ...
                <div className="bg-gradient-to-br from-secondary-800 to-primary-500 dark:from-purple-500 dark:to-blue-500 rounded-2xl px-6 py-4 min-w-[200px] shadow-xl shadow-primary-500/25 dark:shadow-purple-900/40 transition-all duration-300 group-hover:shadow-2xl group-hover:shadow-purple-500/30 group-hover:-translate-y-1">
