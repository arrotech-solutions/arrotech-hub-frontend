            ...
            <div className="text-center py-8">
              ...
              <div className="flex items-center justify-center space-x-4">
                ...
                <button
                  ...
                  className="flex items-center space-x-2 px-6 py-2.5 bg-gradient-to-r from-secondary-800 to-primary-500 text-white rounded-lg hover:from-secondary-900 hover:to-primary-600 transition-all"
                >
          ...
          <div className="flex items-center justify-between px-6 py-4 border-t border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-800/50">
            ...
            {activeStep < 2 ? (
              <button
                ...
                className="px-6 py-2.5 bg-gradient-to-r from-secondary-800 to-primary-500 text-white rounded-lg hover:from-secondary-900 hover:to-primary-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Next
              </button>
            ) : (
